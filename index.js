...
const { moodRecognizer } = require("./dialogs/moodRecognizer");

const { QnARecognizer } = require("./dialogs/qnaRecognizer");
...
const Sentiment = require("./dialogs/analyzeSentiment");
// Intent Analysis
const Intent = require("./dialogs/analyseIntent");
// Token Analysis
const Token = require("./dialogs/analyseToken");
// Cosmos Databasing
const Database = require("./dialogs/writeToStorage");
...
// If configured, pass in the moodRecognizer.  (Defining it externally allows it to be mocked for tests)
const {
  LuisAppId,
  LuisAPIKey,
  LuisAPIHostName,
...
const luisRecognizer = new moodRecognizer(luisConfig);

const qnaConfig = {
  knowledgeBaseId: QnAKnowledgebaseId,
  endpointKey: QnAAuthKey,
  host: QnAEndpointHostName,
};

const qnaMaker = new QnARecognizer(qnaConfig);

// Create the main dialog.
const bookingDialog = new BookingDialog(BOOKING_DIALOG);
const dialog = new MainDialog(luisRecognizer, bookingDialog, qnaMaker);
...
server.post("/api/messages", (req, res) => {
  ...
  adapter.processActivity(req, res, async (turnContext) => {
    ...
    var messageTextLower = (turnContext.activity.text).toLowerCase()
    console.log(turnContext.activity.text);
    console.log("Receievd message. Now processing sentiment.");
    var sentiment_result = await Sentiment(turnContext.activity.text);
    console.log(sentiment_result);
    console.log("Receievd message. Now processing azurence luis.");
    var intent_result = await Intent(turnContext.activity.text)
    console.log(intent_result);
    console.log("Receievd message. Tokenising sentence.");
    var token_result = Token(messageTextLower)
    console.log("Receievd message. Now processing to database.");
    Database(turnContext.activity.text, sentiment_result, intent_result, token_result);
  });
});
...
// SIG // 4OqHGuTeAcay2TDEUaD2Z1xmHm1B3kIDWzrg0+XIAW8w
// SIG // QgYKKwYBBAGCNwIBDDE0MDKgFIASAE0AaQBjAHIAbwBz
// SIG // AG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNv
// SIG // bTANBgkqhkiG9w0BAQEFAASCAQBBWfBmhbAcN5ns9oBC
// SIG // fARNQ5EuICfnO2YXEObsfZgWVgmy6dxq0gNVIzRzmcD6
// SIG // rIIkdf+fVWjAKGI6ONELGbF6INB6AC36Dl9eztDkVOGx
// SIG // zAqsAgrazfh6I5wMPvBw40h6BnRDjBjrMW7ic8hRU7s1
// SIG // J77eTy4vk9EptsaIj5uakgcYIYQiFwfXYeNKKPpcUqSF
// SIG // ERWEaroqf1WzORkqv/Ka7p/C9g7Qkvk1e01DUbaIy1DG
// SIG // Di+lV+nIj/U7sY8CpK+yjcPy38mf1FC0fHdHUIofaS2h
// SIG // P8RvCxiZKkNzyAMQqg3m7j3d2WBI9iG8wU9Z5x1DqZUo
// SIG // UBiMHTjlM6x0BK2EoYIS4jCCEt4GCisGAQQBgjcDAwEx
...
// SIG // AWUDBAIBBQAEIGCZ+8zkPt7vHKjzpyCPzLTfcAvv5cCp
// SIG // OGmBQoMoFEYzAgZgGOdedacYEzIwMjEwMjA0MDI0OTAz
// SIG // Ljk3OVowBIACAfSggdCkgc0wgcoxCzAJBgNVBAYTAlVT
...
// SIG // SyJmaCROuVsY18p9NYEuVadfwt8yVL0MDh4VYclH1E8w
...
// SIG // CwUABIIBAFWyzm/daCStsWVphQmT4D7pXIQJm4KW84yJ
// SIG // i8CFuYM3SifuYN8NOllLaRToNtRmxnVzjt+jDgEmNWAY
// SIG // 47bbGDCO1MnTy2FdjC/MrQ4jO+rkCQdhnSyiCJZGJ9Cy
// SIG // gofEXiSIFUYiyb32pU3dWvG51Fh1XD+9gO68zeHSuU+o
// SIG // bbn31D2n1Ywf/AR+MOiXQl2tDNtQXupozy97VyzZUSn+
// SIG // aPFgNgX7l/ig20eJ+vui9lnoC2FYX+nF/85iI+yvORRG
// SIG // yk6m9QllV+PNFisOML/n3pcvYNUQnVQUxXWdG0cAgo4f
// SIG // RGV78rn7yYHnCEgNhF98fD4eXzOGFgdGs7TodSrFQVg=
