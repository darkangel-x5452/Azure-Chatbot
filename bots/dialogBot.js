...
class DialogBot extends ActivityHandler {
  ...
  async getUploadedAttachment(turnContext) {
    const imageData = fs.readFileSync(
      path.join(__dirname, "../resources/architecture-resize.png")
    );
    const connector = turnContext.adapter.createConnectorClient(
      turnContext.activity.serviceUrl
    );
    const conversationId = turnContext.activity.conversation.id;
    const response = await connector.conversations.uploadAttachment(
      conversationId,
      {
    ...
    const attachmentUri =
      baseUri +
      (baseUri.endsWith("/") ? "" : "/") +
      `v3/attachments/${encodeURI(response.id)}/views/original`;
    return {
      name: "architecture-resize.png",
...
// SIG // bTANBgkqhkiG9w0BAQEFAASCAQC578VMBSKp/DuZ9Yot
// SIG // EjPbaGNgbmM0ZQ4ewy3zNY2fsaVsebNy+7XiUdHh9iic
// SIG // vyS6f4FqmeVbk+RU7E8DSFbbwOQRWo0hdeGHPq3agesS
// SIG // clxkH06QwSo756Y/48Rsm7R6kWZ/aLKitzpeLjw70Gyj
// SIG // qm5slKK03n2b/UWSn2ryygM35pIwnxd+0Nj9odqG6nKN
// SIG // XSUEjmlBc/0kwpyPm0wWoOsLpS6jG7s2xAnwjFTJUmjJ
// SIG // Xzy0SzehVNSBjlvqClgoG/FnM4VOnDH2zSZngMdcE4ag
// SIG // quprfg3NHlB5GjeThlIZ3wTEIy+wBPreItdgbMmNRJJf
// SIG // 8zaC3wurOzV+eUc0oYIS4jCCEt4GCisGAQQBgjcDAwEx
...
// SIG // AWUDBAIBBQAEIFdYC334W3vkkeq0/GreTg5SaZQQdq/w
// SIG // MjHZbYn9dgSxAgZgGOdedcAYEzIwMjEwMjA0MDI0OTA1
// SIG // LjEwM1owBIACAfSggdCkgc0wgcoxCzAJBgNVBAYTAlVT
...
// SIG // KhjRp5fl3+NPv+guC5SdWioysw0KsuMXK6v8Fk/uZAMw
...
// SIG // CwUABIIBAFY7rRLMpzPV2SjA1NhN1mhGM61z8HfgYWLO
// SIG // q+7/iJR3biKNsqvAEd56R1zFjqgSxEP9sEtVfJautwhE
// SIG // NS4g8Fftsgu9cXt/grtRRuNZQ3wsbGmZ27uXwoGLse6g
// SIG // b+dXqw+tvnP1svG7nG8+Ydn4sYJJtfu2xP2WLy6lYxIu
// SIG // PCi5phbEbP36IL9JJqV6hislLhI5PW+ZE7OuTndmccyt
// SIG // x1PqpnGJR+LSGlWKGA+QmL+Y8c9aeqVq/0fCJB5BmR3I
// SIG // Bci0aM89p1pPG0MzObn+mX7wVNfqkSB+k/9NyyYRzQc3
// SIG // kT+2C0/X8HlVcwbMgPOSbS9HIyZWfAc4GFLL8UPPdao=
